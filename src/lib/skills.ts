...
export const SKILL_SEED = [
  ...
  },
  {
    ...
    nameEn: 'General Work',
    skills: ['General helper', 'Event crew', 'Booth setup', 'Packing', 'Loading/unloading', 'Cleaning', 'Runner'],
  },
  {
  ...
  },
  {
    ...
    skills: ['Waiter', 'Kitchen helper', 'Barista helper', 'Cashier', 'Event server'],
  },
  {
    ...
    skills: ['Picker/packer', 'Stock count', 'Delivery assistant', 'Lalamove/runner coordination'],
  },
  {
    slug: 'admin-data',
    nameMs: 'Admin / Data',
