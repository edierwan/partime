...
export default async function NewEmployerJobPage({ searchParams }: { searchParams: { error?: string } }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <form action={createEmployerJob} className="card card-pad grid gap-4 md:grid-cols-2">
        ...
        <div className="md:col-span-2"><label className="label">Description</label><textarea className="input min-h-[140px]" name="description" placeholder="Role details, requirements, dress code, reporting notes" /></div>
